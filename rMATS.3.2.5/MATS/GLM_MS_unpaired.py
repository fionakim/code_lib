...
def myfunc_marginal_1(x, *args):
    ...
    return (
    myfunc_marginal(beta1, I1, S1, psi1, var1, inclusion_length, skipping_length) + myfunc_marginal(beta2, I2, S2, psi2,
                                                                                                    var2,
                                                                                                    inclusion_length,
                                                                                                    skipping_length));
...
def myfunc_marginal_1_der(x, *args):
    ...
    skipping_length = args[9];
    return (
    myfunc_marginal_der(beta1, I1, S1, psi1, var1, inclusion_length, skipping_length) + myfunc_marginal_der(beta2, I2,
                                                                                                            S2, psi2,
                                                                                                            var2,
                                                                                                            inclusion_length,
                                                                                                            skipping_length));
...
def MLE_marginal_iteration(i1, i2, s1, s2, effective_inclusion_length, effective_skipping_length):
    ...
    while ((iter_cutoff > 0.01) & (count <= iter_maxrun)):
        count += 1;
        print('unconstrain_MLE_marginal_value_1_der');
        print(myfunc_marginal_der(beta_0, i1, s1, psi1, var1, effective_inclusion_length, effective_skipping_length));
        print('unconstrain_MLE_marginal_value_2_der');
        print(myfunc_marginal_der(beta_1, i2, s2, psi2, var2, effective_inclusion_length, effective_skipping_length))
